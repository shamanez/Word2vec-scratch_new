...
# Context size
C = 5   #This is for the number of words in the context for a windwow.  this can be change from 1 to 5.

# Reset the random seed to make sure that everyone gets the same results
random.seed(31415)
np.random.seed(9265)
print("creating initial word vectors")
#here this is  10 dimentional vectors for all the tokanized words that is 19539. then we add another vectors with same dimetions of 19539. So the wordvector metric is (39078, 10) matrix
