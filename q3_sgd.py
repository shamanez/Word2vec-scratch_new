...
#here the f is the funcion that can give cost and the grad for all the vecs , X0 is the all the vectors. 
#how many iterations.
    ...
    for iter in range(start_iter + 1, iterations + 1):
        ...
        cost = None
        ### YOUR CODE HERE
        cost, grad = f(x)    #getting use of the lambda function.which we insert.
        x -= step * grad   #gradient update 
