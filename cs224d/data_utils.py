...
class StanfordSentiment:
    ...
    def getRandomContext(self, C=5):
        ...
        sentID = random.randint(0, len(allsent) - 1)   #randomly selct the sent ID . using the numbers between 
        sent = allsent[sentID]        #selecting the scent.
        wordID = random.randint(0, len(sent) - 1) #selecting the word ID.
